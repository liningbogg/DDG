...
def divide_image(image_with_border, image_ori_id, w_subnum, h_subnum, min_overlop, input_shape):
...
def data_achieve(hostid, host_user, database, host_passwd, labels_contributor_set, input_shape, min_overlop, padding):
    ...
    for image_id in label_set_ori:
        ...
        sql_image_achieve = "select data_byte from ocr_pdfimage where id=%s" %  image_id 
